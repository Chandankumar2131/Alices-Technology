...
export default function Modal({ open, onClose, title, children, footer }) {
  ...
  return createPortal(
    <div className="animate-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-3 backdrop-blur-md sm:p-4">
      <div className="animate-modal max-h-[calc(100dvh-1.5rem)] w-full max-w-lg overflow-hidden rounded-lg border border-white/10 bg-slate-950/95 shadow-[0_28px_90px_rgba(0,0,0,0.48)] ring-1 ring-white/[0.04]">
